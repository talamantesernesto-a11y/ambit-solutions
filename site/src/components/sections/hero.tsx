      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8 py-32 lg:py-40 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-end">
          ...
          <div className="lg:col-span-8 xl:col-span-7">
            ...
            <h1 className="animate-fade-up delay-100 text-[clamp(2.5rem,5.5vw,4.5rem)] font-bold text-[#FFF1E6] leading-[1.05] tracking-tight hero-heading">
              Construimos el{" "}
              <span className="italic font-normal text-brand-sand">futuro</span>
              <br />
              <span className="text-primary">de México</span>
            </h1>

            <p className="animate-fade-up delay-200 mt-8 text-[17px] text-secondary-200 leading-relaxed max-w-lg">
              Cadena de valor completa: de la producción de materiales a la
              supervisión final. Un solo interlocutor. Certeza de entrega.
            </p>
